...
{
    /**
     * @Route("/company/get/asc", name="get_company_asc", methods={"GET"})
     */
    ...
    /**
     * @Route("/company/get/desc", name="get_company_desc", methods={"GET"})
     */
    ...
    /**
     * @Route("/company/get/Type/{name}", name="get_company_by_company_type", methods={"GET"})
     */
    ...
    /**
     * @Route("/typeCompany/get", name="get_company_type", methods={"GET"})
     */
